...
// 2025_07_23_152622_hell_yeah.php
...
{
    try {
        echo "Attempting to table 'hell_yeah' table..." . PHP_EOL;
        Capsule::schema()->table('hell_yeah', function (Blueprint $table) {
        ...
        echo "'hell_yeah' table tabled successfully!" . PHP_EOL;
        Logger::log("MIGRATION SUCCESS: tabled 'hell_yeah' table.");

    } catch (\Exception $e) { // Catch any general PHP Exception
        // Log the detailed error message
        $errorMessage = "Error tableing 'hell_yeah' table: " . $e->getMessage();
...
{
    try {
        echo "Attempting to drop 'hell_yeah' table..." . PHP_EOL;
        Capsule::schema()->dropIfExists('hell_yeah');
        echo "'hell_yeah' table dropped successfully!" . PHP_EOL;
        Logger::log("MIGRATION SUCCESS: Dropped 'hell_yeah' table.");

    } catch (\Exception $e) {
        $errorMessage = "Error dropping 'hell_yeah' table: " . $e->getMessage();
        echo $errorMessage . PHP_EOL;
        Logger::log("MIGRATION FAILED: " . $errorMessage);
        throw $e;
    }
