    ...
    ?>
            ...
            <form action="/staff/users/store" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control dark-txt light-bg" id="password" name="password" required maxlength="30">
                </div>

                <div class="mb-3">
                    <label for="confirm_password" class="form-label light-txt">Confirm Password</label>
                    <input type="password" class="form-control dark-txt light-bg" id="confirm_password" name="confirm_password" required maxlength="30">
                </div>
                ...
                <div class="d-grid gap-2 mt-4">
                    <button type="submit" onclick=" return confirm('Are you sure you want to add this user?')" class="btn btn-primary btn-lg">Add User</button>
